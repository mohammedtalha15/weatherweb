...
export default function PhysicsSlider({
    ...
    return (
        <motion.div
            className="weather-card p-5 bg-neutral-900/50 border-neutral-800"
        ...
        >
            ...
            {showTooltip && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 5 }}
                    className="mt-3 px-3 py-2 rounded-lg bg-neutral-800 text-xs text-gray-300 border border-neutral-700"
                >
                    {description}
                </motion.div>
            )}
            ...
            {isExtreme && (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="mt-3 px-3 py-2 rounded-lg bg-amber-900/20 border border-amber-700/30 text-amber-500 text-xs flex items-center gap-2"
                >
                    <span>⚠️</span>
