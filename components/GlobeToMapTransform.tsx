    ...
    useEffect(() => {
        const loadWorldData = async () => {
            try {
                ...
                setWorldData(fallbackData as any)
            }
        }
    ...
    return (
        <div className="relative flex items-center justify-center w-full h-full">
            ...
            <div className="absolute bottom-4 right-4 flex gap-2 z-10">
                <Button onClick={handleAnimate} disabled={isAnimating} className="cursor-pointer min-w-[120px] rounded bg-white text-black hover:bg-gray-200">
