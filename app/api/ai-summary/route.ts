    ...
    try {
        ...
        if (!apiKey) {
            ...
            return NextResponse.json({
                ...
                dayFeeling: `Your day would feel ${weatherOutput.temperature > 30 ? 'hot and oppressive' : weatherOutput.temperature < 10 ? 'cold and crisp' : 'pleasant'}. The ${weatherOutput.windSpeed} km/h winds would ${weatherOutput.windSpeed > 20 ? 'make it feel cooler' : 'be barely noticeable'}. ${weatherOutput.humidity > 70 ? 'High humidity would make it feel sticky.' : 'Low humidity would make the air feel dry.'}`,
